...
```powershell
python .claude/skills/package/scripts/clean.py
```
...
python .claude/skills/package/scripts/clean.py --execute

# Keep data and logs
python .claude/skills/package/scripts/clean.py --execute --keep-data

# Skip secret sanitization
python .claude/skills/package/scripts/clean.py --execute --no-sanitize
```
