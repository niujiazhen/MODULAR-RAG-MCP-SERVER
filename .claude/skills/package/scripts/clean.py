...
Usage:
    python .claude/skills/package/scripts/clean.py          # dry-run (show what would be deleted)
    python .claude/skills/package/scripts/clean.py --execute # actually delete
    python .claude/skills/package/scripts/clean.py --execute --keep-data  # keep data/ & logs/
"""
...
REPO_ROOT = Path(__file__).resolve().parents[4]  # .claude/skills/package/scripts → repo root
